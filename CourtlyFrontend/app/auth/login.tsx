...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    logoImage: { width: 110, height: 110, alignSelf: 'center', marginBottom: 28 },
    ...
    forgotText: { color: c.textSecondary, fontSize: 14 },
        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity style={[styles.btn, loading && styles.btnDisabled]} onPress={handleLogin} disabled={loading} activeOpacity={0.8}>
              {loading ? <ActivityIndicator color="#fff" size="small" /> : <Text style={styles.btnText}>Iniciar sesión</Text>}
            </TouchableOpacity>
