...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    filterChipPrimary: { borderColor: c.primary, backgroundColor: c.primary + '18' },
    filterChipPrimaryText: { color: c.primary, fontSize: 13, fontWeight: '600' },
    ...
    dropdownItemActive: { backgroundColor: c.primary + '12' },
    dropdownText: { color: c.textSecondary, fontSize: 14 },
    ...
    mapControlText: { color: c.textPrimary, fontSize: 12, fontWeight: '700' },
    ...
    markerSelected: { backgroundColor: c.accent, transform: [{ scale: 1.1 }] },
    ...
    sheetCourtName: { color: c.textPrimary, fontSize: 17, fontWeight: '700' },
    sheetMeta: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
    sheetMetaText: { color: c.textSecondary, fontSize: 12 },
    sheetDot: { color: c.textMuted },
    sheetCloseBtn: { padding: 4, marginLeft: 8 },
    sheetTagRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 18, marginBottom: 14 },
    sheetTag: { backgroundColor: c.secondary, borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4 },
    sheetTagText: { color: c.textSecondary, fontSize: 12, fontWeight: '500' },
    sheetSectionLabel: {
    ...
    sheetMatchTime: { color: c.textPrimary, fontWeight: '600', fontSize: 14 },
    spotsRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
    spotsText: { color: c.textSecondary, fontSize: 12, fontWeight: '500' },
    spotsTextUrgent: { color: c.accent },
                    ...
                    <View style={styles.sheetMatchRight}>
                      <View style={styles.spotsRow}>
                        <Ionicons
                          name="people-outline"
                          size={13}
                          color={match.spotsLeft === 1 ? colors.accent : colors.textSecondary}
                        />
                        <Text style={[styles.spotsText, match.spotsLeft === 1 && styles.spotsTextUrgent]}>
